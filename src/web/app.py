...
@app.get("/automod", response_model=None)
...
@app.get("/automod/new", response_model=None)
...
@app.post("/automod/new", response_model=None)
...
@app.get("/automod/{rule_id}/edit", response_model=None)
...
@app.post("/automod/{rule_id}/edit", response_model=None)
...
@app.post("/automod/{rule_id}/delete", response_model=None)
...
@app.post("/automod/{rule_id}/toggle", response_model=None)
...
@app.get("/automod/logs", response_model=None)
...
@app.get("/automod/settings", response_model=None)
...
@app.post("/automod/settings", response_model=None)
...
@app.get("/joinrole", response_model=None)
async def joinrole_list(
    ...
    guilds_map, _ = await _get_discord_guilds_and_channels(db)
    roles_by_guild = await _get_discord_roles_by_guild(db)
...
@app.post("/joinrole/new", response_model=None)
...
@app.post("/joinrole/{config_id}/delete", response_model=None)
...
@app.post("/joinrole/{config_id}/toggle", response_model=None)
